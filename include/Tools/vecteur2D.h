...
#include <cmath>
#include <float.h>
#include "Tools/AlgebreLineaire.h"
#include "Tools/Reels.h"
...
public:
	...
	inline const double distance() const;
	 ...
	 * */
	inline static double normeSup(const Vecteur2D& u) { return maxT(abs(u.x), abs(u.y)); }

	//------------------ Vecteur2D ----------------------------------
};

inline const double Vecteur2D::distance() const {
